...
published: true
featured: false
seoTitle: "Athletic Trainer Jobs at JBER Alaska | Licensure & Career Guide"
seoDescription: "Complete guide to working as an athletic trainer at JBER Alaska. Learn about licensure requirements, compensation, cost of living, and how to apply for contract positions."
...
Alaska does not have a temporary or provisional license category, so begin the application process as early as possible.
...
- Eligibility for a federal background investigation (candidates can begin work while the investigation is in process)
