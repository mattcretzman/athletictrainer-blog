...
description: >-
  ...
  Fitness program, including roles, requirements, compensation, and how to apply.
date: '2026-02-15'
...
seoDescription: >-
  ...
  trainers. Learn about roles, compensation, requirements, and locations.
...
H2F facilities are currently operational at the following Army installations:
...
### Forecasted H2F Locations

The program continues to expand, with facilities planned for the following additional installations:
...
- **Security clearance eligibility** - Ability to complete a Tier 1 background check (no secret clearance required)
...
H2F athletic trainers receive competitive compensation that varies based on several factors:
...
- Specialized skills and advanced experience command higher compensation
...
<FAQ>
  ...
  <FAQItem question="What is the security clearance process like?">
    H2F positions require a Tier 1 background check — no secret security clearance is required. PSI guides you through the entire process. Most candidates are cleared and able to begin work on schedule.
  </FAQItem>
  ...
  <FAQItem question="Is there room for new graduates?">
    New graduates are welcome to apply and are encouraged to do so early in their job search. However, H2F positions require post-certification clinical experience for candidates to qualify for placement. PSI's recruitment team can advise you on the right time to apply and what experience will strengthen your candidacy.
  </FAQItem>
</FAQ>
